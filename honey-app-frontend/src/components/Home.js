        ...
        <div id="home" className="home">
            ...
            <div className = 'home-text-container'>
                ...
                <div className = 'homebuttons-container'>
                    <button className = 'home-shop-button' onClick={() => scrollToSection('store')}>Get your Honey</button>
                    <button className = 'home-abouthoney-button' onClick={() => scrollToSection('about')}>Explore More</button>
                </div>
